...
class Product(Resource):
    ...
    def delete(self,id):
        ...
        db.session.commit()
        return {'message': 'Producto borrado'}, 204
    ...
    def get(self):
        ...
        if precio_minimo:
            try:
                ...
                return {'message': 'Precio minimo debe ser un número válido'}, 400
        ...
        if precio_maximo:
            try:
                ...
                return {'message': 'Precio maximo debe ser un número válido'}, 400
